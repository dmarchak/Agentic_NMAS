...
**23 open** (counted from the rows, 2026-09-25): 19 recorded only in prose
(A2–D2, with A4, C6–C10, C12–C14 and C17 added the same day; B4, D3, C11, C15 and C16 added and closed), 4 in the plan without a stage (E1–E4, one of which is Stage 3.3's
...
By kind: **15 build**, **3 decide-then-build**, **4 decide**, **2 verify**.

...
(A2–D2, with A4, B4, C6–C10 and C12–C14 added the same day; D3, C11 and C15 added and fixed), 4 in the plan without a stage (E1–E4, one of which is Stage 3.3's
...
By kind: **15 build**, **3 decide-then-build**, **3 decide**, **2 verify**.

...
GATES = {
    ...
    "onboard.abandon": _g(C, "deletes the device's records from NetBox and the repository",
                          "onboard_abandon"),
    "api_execute_command": _g(C, "sends a free-form command, config mode included (cut in P.3 step 2)"),
    "run_script": _g(C, "runs a script against a device (cut in P.3 step 2)"),
    "restore_backup": _g(C, "replays a backup onto a device (cut in P.3 step 2)"),
    ...
    "bulk_execute": _g(C, "sends commands to many devices, config mode included"),
    "bulk_reload": _g(C, "reloads devices"),
    "bulk_remove_static_routes": _g(C, "negates static routes on devices (cut in P.3 step 2)"),
    ...
    "configure_apply": _g(C, "pushes generated config (its push is cut in P.3 step 2)"),
    ...
    "netbox_sync": _g(A, "legacy unguarded NetBox write (cut in P.3 step 2)"),
    "netbox_sync_all": _g(A, "legacy unguarded NetBox write (cut in P.3 step 2)"),
    "netbox_remove": _g(A, "legacy unguarded NetBox delete (cut in P.3 step 2)"),

...
**20 open** (counted from the rows, 2026-09-25): 16 recorded only in prose
(A2–D2, with A4, B4, C6–C10 added the same day; D3 added and fixed), 4 in the plan without a stage (E1–E4, one of which is Stage 3.3's
...
By kind: **14 build**, **3 decide-then-build**, **1 decide**, **2 verify**.
